...
public class RecruitController {
	...
	//推介职位
	@RequestMapping(value="/search/recommend/{a}",method= RequestMethod.GET)
	public Result recommend(@PathVariable String a){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.recommend(a));
	}
	//最新职位
